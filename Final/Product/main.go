...
var (
	DBCONNECTION string = "host=localhost user=postgres password=Global@567# dbname=product port=5432 sslmode=disable TimeZone=Asia/Shanghai"
	PORT         string = ":50080"
)
...
func main() {
	...
	r.PUT("/Orders/Update/:id", oh.UpdateOrderHand())
